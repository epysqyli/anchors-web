import { isServer, delegateEvents, createComponent as createComponent$1, renderToStringAsync, spread, escape, ssr, ssrHydrationKey, useAssets, ssrAttribute, HydrationScript, NoHydration, ssrElement } from 'solid-js/web';
import { createSignal, onCleanup, getOwner, runWithOwner, createMemo, createContext, useContext, createComponent, createRenderEffect, untrack, on, startTransition, resetErrorBoundaries, children, createRoot, Show, sharedConfig, createUniqueId, ErrorBoundary as ErrorBoundary$1, createEffect, Suspense } from 'solid-js';
...
const _tmpl$$2 = ["<main", "><h1>Hello world!</h1><!--#-->", "<!--/--><p>Visit <a href=\"https://solidjs.com\" target=\"_blank\">solidjs.com</a> to learn how to build Solid apps.</p></main>"];
const Home = () => {
  return ssr(_tmpl$$2, ssrHydrationKey(), escape(createComponent$1(Counter, {})));
};
      ...
      return [createComponent$1(Head, {
        get children() {
          return [createComponent$1(Title, {
            children: "SolidStart - With Vitest"
